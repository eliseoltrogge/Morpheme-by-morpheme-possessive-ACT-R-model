...
# 	);
    ...
    lines(fitted[1:3], type="b", pch=19, lwd=2, lty=1);
    lines(c(rep(NA,3),fitted[4:6]), type="b", pch=19, lwd=2, lty=1);

    text(x=c(2,6),y=c(410,410),labels=c("embedded verb","main verb"));
...
if (plot.data == "YES") {
    lines(data[1:3], type="b", pch=21, lwd=2, lty=2);
    lines(c(rep(NA,3),data[4:6]), type="b", pch=21, lwd=2, lty=2);
